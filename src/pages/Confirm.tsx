...
export default function Confirm() {
  ...
  const { handleSelectToken } = useTokenSelection();

  // Custom hook for token searching - no auth requirement
  const { results, isLoading, error } = useTokenSearch(searchTerm, true); // Always allow search
